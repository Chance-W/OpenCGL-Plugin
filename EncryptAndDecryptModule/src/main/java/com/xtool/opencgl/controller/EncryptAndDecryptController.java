...
import com.xtool.opencgl.utils.GuiUtils;
import com.xtool.opencgl.utils.JavaFxViewUtil;
import com.xtool.opencgl.utils.MorseConventer;
 ...
 * @author Chance.W
 */
public class EncryptAndDecryptController extends com.graphical.EncryptAndDecrypt.EncryptAndDecryptView {
    ...
    private void initView() {
        ...
        for (int i = 0; i < cryptos.length; i++) {
            if (!"".equals(cryptos[i])) {
                MFXRadioButton radioButton = new MFXRadioButton(cryptos[i]);
