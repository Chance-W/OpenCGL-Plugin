...
public interface WsdlSettings {
    ...
    public static final String XML_GENERATION_SKIP_COMMENTS = WsdlSettings.class.getSimpleName() + "@"
            + "dom4j-generation-skip-comments";
