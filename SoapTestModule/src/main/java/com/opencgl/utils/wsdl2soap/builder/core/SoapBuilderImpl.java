package com.opencgl.utils.wsdl2soap.builder.core;

import com.opencgl.utils.wsdl2soap.builder.SoapBuilder;
import com.opencgl.utils.wsdl2soap.builder.SoapOperation;
import com.opencgl.utils.wsdl2soap.builder.SoapOperationBuilder;
import com.opencgl.utils.wsdl2soap.builder.SoapOperationFinder;
import com.opencgl.utils.wsdl2soap.util.SoapLegacyFacade;
...
public class SoapBuilderImpl implements SoapBuilder {
    ...
    public List<SoapOperation> getOperations() {
        List<SoapOperation> operationNames = new ArrayList<>();
