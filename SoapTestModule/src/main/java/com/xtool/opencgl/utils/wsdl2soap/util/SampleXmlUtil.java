...
import com.xtool.opencgl.utils.wsdl2soap.ws.SoapMultiValuesProvider;
...
public class SampleXmlUtil {
     ...
     * By default the XML-Schema root element is added since it is quite util in .NET
     * services and generates a sample dom4j fragment of about 300 kb!.
     */
    ...
    public String createSample(SchemaType sType) {
        ...
        // end of the doc so we use the original dom4j object that the cursor was
