...
import com.xtool.opencgl.utils.wsdl2soap.ws.annotation.ThreadSafe;
import com.xtool.opencgl.utils.wsdl2soap.ws.common.Wsdl11Writer;
...
public class SoapMessageBuilder {
    ...
    public static String buildFault(String faultcode, String faultstring, SoapVersion soapVersion, SoapContext context) {
        ...
        if (soapVersion == SoapVersion.Soap11) {
            ...
            emptyResponse = XmlUtils.setXPathContent(emptyResponse, "//soap:Text/@dom4j:lang", "en");
        }
