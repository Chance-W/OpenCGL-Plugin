...
public class ZookeeperToolService {
    ...
    public void connectOnAction() {
            ...
            protected List<ZkNode> call() throws Exception {
                if (zkClient == null) {
                    zkClient = new ZkClient(zookeeperToolController.getZkServersTextField().getText().trim(),
                            zookeeperToolController.getConnectionTimeoutSpinner().getValue());
        ...
        task.setOnSucceeded(e -> {
            ...
            populateTreeItems(root, "/", task.getValue());
    ...
    private List<ZkNode> fetchZkNodes(String path) {
        ...
        for (String name : names) {
            ...
            Stat stat = zkClient.getAcl(childPath).getValue();
    ...
    public void nodeSelectionChanged(TreeItem<String> selectedItem) {
        ...
        Task<Map<String, Object>> task = new Task<Map<String, Object>>() {
            ...
            protected Map<String, Object> call() throws Exception {
                ...
                result.put("data", zkClient.readData(nodePath));
                result.put("aclEntry", zkClient.getAcl(nodePath));
                return result;
            }
        };
