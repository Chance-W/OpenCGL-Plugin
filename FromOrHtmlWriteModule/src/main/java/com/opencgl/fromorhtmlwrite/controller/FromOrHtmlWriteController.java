package com.opencgl.fromorhtmlwrite.controller;
...
import com.opencgl.fromorhtmlwrite.views.FromOrHtmlWriteView;
 ...
 * @since v9.0
 */
public class FromOrHtmlWriteController extends FromOrHtmlWriteView {
    private static final Logger logger = LoggerFactory.getLogger(FromOrHtmlWriteController.class);
