...
public class FtpServerTableBean {
	...
	private final SimpleStringProperty homeDirectory;
	private final SimpleBooleanProperty downFIle;
	private final SimpleBooleanProperty upFile;
	//读写权限
	private final SimpleBooleanProperty deleteFile;
	...
	public FtpServerTableBean(String propertys) {
		...
		this.downFIle = new SimpleBooleanProperty(Boolean.parseBoolean(strings[3]));
		this.upFile = new SimpleBooleanProperty(Boolean.parseBoolean(strings[4]));
		this.deleteFile = new SimpleBooleanProperty(Boolean.parseBoolean(strings[5]));
		this.isEnabled = new SimpleBooleanProperty(Boolean.parseBoolean(strings[6]));
	}
