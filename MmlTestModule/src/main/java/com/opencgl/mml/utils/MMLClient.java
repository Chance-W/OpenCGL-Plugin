...
public class MMLClient implements IMMLClient, ManagedClient, Testable {
    ...
    public void init(Properties param) throws Exception {
        ...
        this.idleTime = Integer.parseInt(param.getProperty("idleTime", "120"));
        ...
        this.port = Integer.parseInt(param.getProperty("port"));
        this.timeOut = Integer.parseInt(param.getProperty("timeOut", "1000"));
